      ...
      <div className="mx-auto grid h-14 w-full max-w-6xl grid-cols-[auto_1fr_auto] sm:grid-cols-[1fr_auto_1fr] items-center gap-2 px-3 sm:h-16 sm:gap-3 sm:px-4">
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-3">
          ...
          {isAdmin && (
            <button
              type="button"
              className="border border-yellow-500/40 bg-yellow-500/10 text-yellow-300 hover:bg-yellow-500/20 px-3 h-9 text-xs font-bold uppercase tracking-widest transition-colors flex items-center gap-1.5"
